...
contract MoodNFTTest is Test {
    ...
    function testInitializedCorrectly() public view {
        assert(keccak256(abi.encodePacked(NFT_NAME)) == keccak256(abi.encodePacked(moodNFT.name())));
        assert(keccak256(abi.encodePacked(NFT_SYMBOL)) == keccak256(abi.encodePacked(moodNFT.symbol())));
    }
